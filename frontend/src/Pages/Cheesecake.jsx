...
const Cheesecake = () => {
  ...
  const handleShowLess = () => {
    ...
    setShowLess(false); // Ascunde opțiunea "Show Less"
  };

  // Aplică filtrarea pe produsele din categoria "Torturi"
  let filteredProducts = filterProducts();

  // Aplică sortarea pe produsele filtrate
  let sortedProducts = sortProducts(filteredProducts);

  // Funcție pentru a împărți produsele în rânduri de câte 4
  ...
  // Afișează produsele împărțite în rânduri de câte 4
  ...
  return (
    <div className="torturi-container">
      <div className="search-sort-container">
        <input
          type="text"
          placeholder="Căutare cheesecake..."
          value={searchTerm}
